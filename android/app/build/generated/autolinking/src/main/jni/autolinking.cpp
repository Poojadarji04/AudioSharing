...
#include <rndocumentpickerCGen.h>
...
auto module_rndocumentpickerCGen = rndocumentpickerCGen_ModuleProvider(moduleName, params);
if (module_rndocumentpickerCGen != nullptr) {
return module_rndocumentpickerCGen;
}
